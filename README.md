...
- Street maps are an optional, keyless enhancement (MapLibre GL +
  ...
  without them
- Country outlines are carried inside the file (Natural Earth 1:110m,
  public domain, simplified and delta-encoded) — no tiles, no network
- 100% open source
